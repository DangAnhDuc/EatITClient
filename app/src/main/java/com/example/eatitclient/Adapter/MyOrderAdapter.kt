...
class MyOrderAdapter(private val context: Context, private val orderList: List<Order>) :
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal var txt_order_commnent: TextView? = null
        ...
        init {
            ...
            txt_order_commnent = itemView.findViewById(R.id.txt_order_comment) as TextView
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        Glide.with(context!!)
            .load(orderList[position].cartItemList!![0].foodImage).into(holder.img_order!!)
        ...
        holder.txt_order_commnent!!.text =
            StringBuilder("Order comment: ").append(orderList[position].comment)
